...
from api.distributed.pffdst.PffDSTAPI import FedML_init, FedML_PffDST_distributed
...
if __name__ == "__main__":
    ...
    str_process_name = "PffDST (distributed):" + str(process_id)
